            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="address">Endereço de Origem *</Label>
                    <Select required>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <Input id="notes" placeholder="Notas adicionais sobre a saída" />
                  </div>
                </div>
                
                <div className="flex justify-end gap-2">
                  <Button type="button" variant="outline">Cancelar</Button>
                  <Button type="submit" variant="destructive">Confirmar Saída</Button>
                </div>
              </form>
            </CardContent>
          </Card>
